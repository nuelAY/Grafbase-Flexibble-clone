      ...
      <footer className='flexStart footer'>
          <div className='flex flex-col gap-12 w-full'>
              ...
              <p className='text-start text-sm font-normal mt-5 max-w-xs'>
                  Lorem ipsum dolor sit amet consectetur, adipisicing elit. Culpa neque tempore vel delectus et, expedita eligendi corrupti quos nihil aliquid est, accusantium ad quis labore eveniet voluptatibus porro minus inventore.
              </p>
          </div>
